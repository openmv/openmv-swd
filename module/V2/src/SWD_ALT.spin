...
con
  ...
  CSW_W_VALUE = $4300_0012 ' STM32F4/STM32F7

  HALT_1_ADDRESS = $E000_EDF0 ' STM32F4/STM32F7
  HALT_1_VALUE = $A05F_0001 ' STM32F4/STM32F7
...
if_z          mov a, m7_id_addr
              ...
              mov fatal_error, fatal_error_t

sub_init_ret  ret

' /////////// Sub Fini

sub_fini      andn outa, swdrst_pin
              rdlong x, #0
              shr x, #1
              add x, cnt
              waitcnt x, #0
...
sub_fini_l    mov x, cnt
              sub x, r_cnt
              cmp c, m4_id_code1 wz
if_z          cmp x, m4_test_time wc
              cmp c, m7_id_code1 wz
if_z          cmp x, m7_test_time wc
if_nc         jmp #fatal_error
