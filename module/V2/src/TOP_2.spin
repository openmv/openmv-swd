...
con
  ...
  _CLKFREQ = 80_000_000 ' 96_000_000
...
dat
  ...
  swd_io_pin byte 2, 5, 8, 11, 14 ' 5, 8, 11, 14, 17
  swd_clk_pin byte 1, 4, 7, 10, 13 ' 4, 7, 10, 13, 16
  swd_res_pin byte 3, 6, 9, 12, 15 ' 6, 9, 12, 15, 18
  ...
  repeat
    ...
    repeat while com.receivedNumber
      ...
      case command_buf
        ...
        $53_57_44_39: ' Ping
          com.writeString(string("Hello World - v3.3.0", com#Carriage_Return, com#Line_Feed))
          quit
